			...
			<div id="filteroptionscontent" class="filteroptionscontent">
				<!-- All Feeds Filter -->
					<div class="allfeedsfilteroptions form-group">
						...
						<input maxlength="14" type="text" class="form-control" maxlength="14" id="AllFeedsTranslation" placeholder="All Feeds Translation" value="<?php echo $AllFeedsTranslation; ?>">
						<label>Background Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="AllFeedsBGColorHex" value="#<?php echo $AllFeedsBGColor; ?>" readonly>
						...
						<div class="colorinput">
							<input class="form-control hex" type="text" id="AllFeedsTextColorHex" value="#<?php echo $AllFeedsTextColor; ?>" readonly>
						...
						<button id="allfeedsfilterreset" class="btn btn-block resetbutton">Reset</button>
					</div>
				<!-- Following Filter -->	
					<div class="followingfilteroptions form-group">
						<div class="title">Following</div>
						<label>Translation</label>
						<input maxlength="14" type="text" class="form-control" id="FollowingTranslation" placeholder="Following Translation" value="<?php echo $FollowingTranslation; ?>">
						<label>Background Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="FollowingBGColorHex" value="#<?php echo $FollowingBGColor; ?>" readonly>
						...
						<label>Text Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="FollowingTextColorHex" value="#<?php echo $FollowingTextColor; ?>" readonly>
						...
						<button id="followingfilterreset" class="btn btn-block resetbutton">Reset</button>
					</div>
				<!-- Categories Filter -->
					<div class="categoriesfilteroptions">
						<div class="title">Categories</div>
						<label>Translation</label>
						<input type="text" maxlength="14" class="form-control" id="CategoriesTranslation" placeholder="Categories Translation" value="<?php echo $CategoriesTranslation; ?>">
						<label>Background Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="CategoriesBGColorHex" value="#<?php echo $CategoriesBGColor; ?>" readonly>
						...
						<label>Text Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="CategoriesTextColorHex" value="#<?php echo $CategoriesTextColor; ?>" readonly>
						...
						<button id="categoriesfilterreset" class="btn btn-block resetbutton">Reset</button>
					</div>
				<!-- Hashtags Filter -->
					<div class="hashtagsfilteroptions">
						<div class="title">Hashtags</div>
						<label>Translation</label>
						<input type="text" maxlength="14" class="form-control" id="HashtagsTranslation" placeholder="Hashtags Translation" value="<?php echo $HashtagsTranslation; ?>">
						<label>Background Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="HashtagsBGColorHex" value="#<?php echo $HashtagsBGColor; ?>" readonly>
						...
						<label>Text Color</label>
						<div class="colorinput">
							<input class="form-control hex" type="text" id="HashtagsTextColorHex" value="#<?php echo $HashtagsTextColor; ?>" readonly>
						...
						<button id="hashtagsfilterreset" class="btn btn-block resetbutton">Reset</button>
					</div>
			</div>
				...
				<!-- Comments Button -->
					<div class="commentsbuttonoptions form-group">
						...
						<label class="sectiontitle">Count Circle</label>
							<label>Background Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="CommentButtonCountBGColorHex" value="#<?php echo $CommentButtonCountBGColor; ?>" readonly>
							...
							<label>Text Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="CommentButtonCountTextColorHex" value="#<?php echo $CommentButtonCountTextColor; ?>" readonly>
						...
						<label class="sectiontitle">Button Text</label>
							<label>Background Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="CommentButtonBGColorHex" value="#<?php echo $CommentButtonBGColor; ?>" readonly>
							...
							<label>Text Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="CommentButtonTextColorHex" value="#<?php echo $CommentButtonTextColor; ?>" readonly>
						...
						<button id="commentsbuttonreset" class="btn btn-block resetbutton">Reset</button>
					</div>
				<!-- Follow Button -->
					<div class="followbuttonoptions form-group">
						...
						<label class="sectiontitle">Button Text</label>
							<label>Background Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="FollowButtonBGColorHex" value="#<?php echo $FollowButtonBGColor; ?>" readonly>
							...
							<label>Text Color</label>
							<div class="colorinput">
								<input class="form-control hex" type="text" id="FollowButtonTextColorHex" value="#<?php echo $FollowButtonTextColor; ?>" readonly>
						...
						<button id="followbuttonreset" class="btn btn-block resetbutton">Reset</button>
					</div>
			</div>
			...
			<div id="additionaloptionscontent" class="additionaloptionscontent">
				<!-- Feed Thumbnail -->
					<div class="feedthumbnailoptions form-group">
						...
						<button id="thumbnailbuttonreset" class="btn btn-block resetbutton">Reset</button>
					</div>
				<!-- Other Settings -->
					<div class="otheroptions form-group">
						...
						<button id="otheroptionsreset" class="btn btn-block resetbutton">Reset</button>
					</div>
			</div>
...
<!-- All Feeds Card -->
	  ...
	  <div class="card livedemo">
	    ...
	    <input type="text" id="searchbar" class="allfeedssearch col-xs-12" placeholder="<?php echo $SearchBarTranslation; ?>">
	    ...
	    <div class="card-block">
	      <!-- All Feeds Area -->
			<div id="allfeeds">
			<!-- Text Feed Cell -->
			 	<div class="feedcell col-xs-12 textfeed">
			 		<!-- Feed User Info -->
			 		...
			 		<!-- Feed Info -->
			 			<div class="feed col-xs-8">
			 				...
			 				<div class="feedmessage">This is the feed message area</div>
			...
			<!-- Image Feed Cell -->
			 	<div class="feedcell col-xs-12 imagefeed">
			 		<!-- Feed User Info -->
			 			<div class="profile col-xs-4">
			 				<div class="feedthumbnail">
